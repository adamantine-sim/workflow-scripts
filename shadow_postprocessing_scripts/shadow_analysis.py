...
def shadow_analysis(plot_sim_field, plot_expt_field, plot_single_time_series, plot_variability_time_series, path_to_adamantine_files, adamantine_filename, output_directory, previous_print_data_path, point_of_interest, rayfile, print_index, plotting_temperature_range, plotting_zoom=1.0):
    ...
    try:
        ...
        if plot_variability_time_series:
            ...
            if not os.path.isdir(previous_print_data_path):
                os.mkdir(previous_print_data_path)
                print("Variability time series listed to plot, but no previous data directory exists. Creating an empty directory now.")
        ...
        print("WARNING: Some issue occured while postprocessing. Still continuing on though...")
        pass
