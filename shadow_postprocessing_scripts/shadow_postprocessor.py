...
parser.add_argument("--sim-field-plot", action='store_true', default='True', help="whether to plot the simulated field")
parser.add_argument("--expt-field-plot", action='store_true', default='True', help="whether to plot the experimental field on the simulation mesh")
parser.add_argument("--single-time-series-plot", action='store_true', default='True', help="whether to plot the time series for a single print")
parser.add_argument("--variability-time-series-plot", action='store_true', default='True', help="whether to plot the time series for a multiple prints")
