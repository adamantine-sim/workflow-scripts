...
parser.add_argument("--previous-print-profile-prefix", help="path and prefix for temperature profile CSV file from previous prints")
...
previous_print_profile_prefix = args.previous_print_profile_prefix
...
shadow_analysis(plot_sim_field, plot_expt_field, plot_single_time_series, plot_variability_time_series, path_to_adamantine_files, adamantine_filename, output_directory, previous_print_profile_prefix, point_of_interest, path_to_visit, rayfile, print_index)